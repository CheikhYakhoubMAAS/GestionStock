 ...
 */
final class Version20201230015041 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_29A5EC27322DFB53 ON produit');
        $this->addSql('ALTER TABLE produit CHANGE id_famille_id famille_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE famille_id id_famille_id INT NOT NULL');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27322DFB53 FOREIGN KEY (id_famille_id) REFERENCES famille (id)');
        $this->addSql('CREATE INDEX IDX_29A5EC27322DFB53 ON produit (id_famille_id)');
    }
}
