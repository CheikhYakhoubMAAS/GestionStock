 ...
 */
final class Version20201224135624 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, designation VARCHAR(50) NOT NULL, resp_comm VARCHAR(50) NOT NULL, resp_finan VARCHAR(50) NOT NULL, adr_liv VARCHAR(50) NOT NULL, adr_facture VARCHAR(100) NOT NULL, tel VARCHAR(14) NOT NULL, portable VARCHAR(14) NOT NULL, fax VARCHAR(14) NOT NULL, email VARCHAR(50) NOT NULL, solde_init DOUBLE PRECISION NOT NULL, solde DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
